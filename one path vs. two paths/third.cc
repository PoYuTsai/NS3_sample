...
main (int argc, char *argv[])
{
 ...
 // system("script log/av1");
  ...
  int package=50;//1024byte
  

//WIRE
  std::string delay_time_P="1s";//point to point set dalay time  on E-ANDSF database ping driver
  std::string data_rate_P="100Kbps";//point to point set Bandwidth

//CSMA WIRELESS
   std::string delay_time_C="1s";
  std::string data_rate_C="100Kbps";
  //try it and enjoy
  /*for(int WIFI_node=10;WIFI_node<20;WIFI_node++){
